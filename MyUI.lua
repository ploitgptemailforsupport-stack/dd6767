...
function GrokaUI:CreateWindow(title, subtitle, icon)
	...
	-- Window chrome buttons in TOP BAR (right side)
	...
	tabsScrollFrame.Size                   = UDim2.new(1, -70, 1, -8)
	...
	tabsRow.Size                   = UDim2.new(0, 0, 1, 0) -- auto width
	...
	-- ============================================================
	-- MIDDLE SECTION (script name/icon left, content right)
	-- ============================================================
	local middleArea = Instance.new("Frame")
	middleArea.Size                   = UDim2.new(1, 0, 1, -46 - 42) -- full minus topBar and bottomBar
	middleArea.Position               = UDim2.new(0, 0, 0, 46)
	middleArea.BackgroundTransparency = 1
	middleArea.Parent                 = main

	-- Left sidebar: script icon + name
	...
	-- ============================================================
	-- BOTTOM BAR (player info left, credits right)
	-- ============================================================
	...
	-- Cover top rounded corners of bottomBar
	...
	-- Player avatar icon (bottom left)
	...
	-- Player name (bottom left, next to avatar)
	...
	-- ============================================================
	-- CREATE TAB  (creates a pill button in the TOP BAR)
	-- ============================================================
	function Window:CreateTab(name, icon)

		-- Pill tab button in the top bar
